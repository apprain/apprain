...
CKEDITOR.plugins.add('table', {init:function (a) {
    var b = CKEDITOR.plugins.table, c = a.lang.table;
    ...
    if (a.contextMenu)a.contextMenu.addListener(function (d, e) {
        if (!d)return null;
        var f = d.is('table') || d.hasAscendant('table');

...
(function () {
    if (!window.CKEDITOR)window.CKEDITOR = (function () {
        var a = {timestamp:'99GE', version:'3.0.1', revision:'4391', _:{}, status:'unloaded', basePath:(function () {
    ...
    e.extend(d.node.prototype, {appendTo:function (h, i) {
        ...
        do if (i.contains(h))return i; while (i = i.getParent())
        return null;
    ...
    a.htmlParser.element = function (l, m) {
        ...
        q.isEmpty = p;
        q.isUnknown = !n[l];
        q._ = {isBlockLike:o, hasInlineStarted:p || !o};
    };
    (function () {
        var l = function (m, n) {
            m = m[0];
    ...
    (function () {
        function l(p, q) {
            ...
            if (this.current)r = this.current[w](false, v, t); else if (p) {
                r = s.endContainer;
                if (s.endOffset > 0) {
        ...
        ;
        d.walker = e.createClass({$:function (p) {
            this.range = p;
            this._ = {};
        }, proto:{end:function () {
            this._.end = 1;
    ...
    (function () {
        var l = function (q) {
            ...
            if (u.type == 3)u = u.split(w); else if (u.getChildCount() > 0)if (w >= u.getChildCount()) {
            ...
            for (var J = B; J < z.length; J++) {
                ...
                while (H) {
                    ...
                    I = H.getNext();
                    if (r == 2)E.append(H.clone(true)); else {
                        H.remove();
                        if (r == 1)E.append(H);
                    }
                    H = I;
            ...
            for (var K = B; K < A.length; K++) {
                ...
                if (!z[K] || F.$.parentNode != z[K].$.parentNode) {
                    ...
                    while (H) {
                        ...
                        I = H.getPrevious();
                        if (r == 2)E.$.insertBefore(H.$.cloneNode(true), E.$.firstChild); else {
                            H.remove();
        ...
        d.range.prototype = {clone:function () {
            ...
            return{start:r.getAddress(q), end:x.isCollapsed ? null : s.getAddress(q), startOffset:t, endOffset:u, normalized:q, is2:true};
            ...
            if (q.type == 1) {
                u = q.getChildCount();
                if (u > s)q = q.getChild(s); else if (u < 1)q = q.getPreviousSourceNode(); else {
                    q = q.$;
            ...
            if (r.type == 1) {
                u = r.getChildCount();
                if (u > t)r = r.getChild(t).getPreviousSourceNode(true); else if (u < 1)r = r.getPreviousSourceNode(); else {
                    r = r.$;
            ...
            if (q.type != 1)if (!r)s.setStartBefore(q); else if (r >= q.getLength())s.setStartAfter(q);
            q = s.endContainer;
            r = s.endOffset;
            ...
            switch (q) {
                case 1:
                    ...
                    while (v || w) {
                        ...
                        while (w) {
                            ...
                            if (z)if (y) {
                                if (x)t = v; else if (v)this.setStartBefore(v);
                            } else y = true;
                            if (w) {
                                var G = w.getPrevious();
                                if (!v && !G) {
                    ...
                    while (v || w) {
                        if (v && !w) {
                            ...
                            if (!y || v.getComputedStyle('display') != 'inline') {
                                y = false;
                                if (x)u = v; else if (v)this.setEndAfter(v);
                            }
                            w = v.getNext();
                        }
                        while (w) {
                ...
                case 3:
                    ...
                    var I = new d.walker(H), J, K, L = d.walker.blockBoundary(q == 3 ? {br:1} : null), M = function (O) {
                        var P = L(O);
                        if (!P)J = O;
                        return P;
                    }, N = function (O) {
            ...
            return{previousBlock:v, nextBlock:w, wasStartOfBlock:y, wasEndOfBlock:z, elementPath:x};
            ...
            var r;
            while (q && q.type == 1) {
                if (q.isEditable())r = q; else if (r)break;
                q = q.getFirst();
            }
            if (r) {
    ...
    (function () {
        ...
        n.prototype = {exec:function (q, r) {
            var s = m(q, this.type);
            if (!s)alert(q.lang.clipboard[this.type + 'Error']);
            return s;
        }};
        var o = c ? {exec:function (q, r) {
            q.focus();
        ...
        j.add('clipboard', {init:function (q) {
            function r(t, u, v, w) {
                var x = q.lang[u];
                q.addCommand(u, v);
                q.ui.addButton(t, {label:x, command:u});
                if (q.addMenuItems)q.addMenuItem(u, {label:x, command:u, group:'clipboard', order:w});
            }
            ...
            if (q.contextMenu) {
                ...
                q.contextMenu.addListener(function () {
                    return{cut:s('Cut'), copy:s('Cut'), paste:b.webkit ? 2 : s('Paste')};
                });
            }
        }});
    })();
    j.add('colorbutton', {requires:['panelbutton', 'floatpanel', 'styles'], init:function (l) {
        ...
        function p(r, s, t) {
            l.ui.add(r, 4, {label:t, title:t, className:'cke_button_' + r.toLowerCase(), modes:{wysiwyg:1}, panel:{css:[a.getUrl(l.skinPath + 'editor.css')]}, onBlock:function (u, v) {
                var w = u.addBlock(v);
                w.autoSize = true;
        ...
        function q(r, s) {
            var t = [], u = m.colorButton_colors.split(','), v = e.addFunction(function (z, A) {
                ...
                l.focus();
                r.hide();
                var B = new a.style(m['colorButton_' + A + 'Style'], z && {color:z});
                l.fire('saveSnapshot');
    ...
    (function () {
        function l(m, n, o, p, q, r, s) {
            ...
            m.ui.addRichCombo(n, {label:p.label, title:p.panelTitle, voiceLabel:p.voiceLabel, className:'cke_' + (o == 'size' ? 'fontSize' : 'font'), multiSelect:false, panel:{css:[a.getUrl(m.skinPath + 'editor.css')].concat(t.contentsCss), voiceLabel:p.panelVoiceLabel}, init:function () {
    ...
    j.add('format', {requires:['richcombo', 'styles'], init:function (l) {
        ...
        l.ui.addRichCombo('Format', {label:n.label, title:n.panelTitle, voiceLabel:n.voiceLabel, className:'cke_format', multiSelect:false, panel:{css:[a.getUrl(l.skinPath + 'editor.css')].concat(m.contentsCss), voiceLabel:n.panelVoiceLabel}, init:function () {
    ...
    j.add('forms', {init:function (l) {
        ...
        if (l.contextMenu) {
            l.contextMenu.addListener(function (p) {
                if (p && p.hasAscendant('form'))return{form:2};
            });
            l.contextMenu.addListener(function (p) {
                if (p) {
                    var q = p.getName();
    ...
    (function () {
        ...
        var x = {elementNames:[
            ...
            var N = M.parent;
            if (N && N.name == 'object') {
                var O = N.attributes.width, P = N.attributes.height;
        ...
        ;
        function L(M, N) {
            var O = [], P = /<\!--\{cke_temp\}(\d*?)-->/g, Q = [/<!--[\s\S]*?-->/g, /<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(N);
        ...
        ;
        j.add('htmldataprocessor', {requires:['htmlwriter'], init:function (M) {
        ...
        a.htmlDataProcessor.prototype = {toHtml:function (M, N) {
            ...
            if (c)M = K(M);
            var P = a.htmlParser.fragment.fromHtml(M, N), Q = new a.htmlParser.basicWriter();
            P.writeHtml(Q, this.dataFilter);
            return Q.getHtml(true);
        }, toDataFormat:function (M, N) {
            var O = this.writer, P = a.htmlParser.fragment.fromHtml(M, N);
            O.reset();
            ...
            for (var w = s.length - 1; w >= 0; w--) {
                ...
                while (v = u.getNextParagraph()) {
                    ...
                    if (t) {
                        ...
                        if (y.state == 2 && !y.isDefaultAlign)v.addClass(t); else if (!x)v.removeAttribute('class');
    ...
    (function () {
        var l = {ol:1, ul:1}, m = /^[\n\r\t ]*$/;
        j.list = {listToArray:function (t, u, v, w, x) {
            ...
            for (var y = 0, z = t.getChildCount(); y < z; y++) {
                ...
                var B = {parent:t, indent:w, contents:[]};
                if (!x) {
            ...
            for (; ;) {
                ...
                if (E.indent == B) {
                    ...
                    C;
                    if (l[E.grandparent.getName()])C = x.createElement('li'); else if (w != 2 && E.grandparent.getName() != 'td')C = x.createElement(D); else C = new d.documentFragment(x);
        ...
        function r(t, u, v) {
            ...
            function I(K) {
                if ((G = F[K ? 'getFirst' : 'getLast']()) && (!(G.is && G.isBlockBoundary()) && (H = u.root[K ? 'getPrevious' : 'getNext'](d.walker.whitespaces(true))) && (!(H.is && H.isBlockBoundary({br:1})))))t.document.createElement('br')[K ? 'insertBefore' : 'insertAfter'](G);
            }
        ...
        s.prototype = {exec:function (t) {
            ...
            while (w.length > 0) {
                ...
                while (I = H.getNextParagraph()) {
                    ...
                    if (L)continue;
                    var Q = M;
                    if (Q.getCustomData('list_group_object'))Q.getCustomData('list_group_object').contents.push(I); else {
                        P = {root:Q, contents:[I]};
        ...
        j.add('list', {init:function (t) {
            var u = new s('numberedlist', 'ol'), v = new s('bulletedlist', 'ul');
            t.addCommand('numberedlist', u);
            t.addCommand('bulletedlist', v);
            t.ui.addButton('NumberedList', {label:t.lang.numberedlist, command:'numberedlist'});
            t.ui.addButton('BulletedList', {label:t.lang.bulletedlist, command:'bulletedlist'});
    ...
    (function () {
        ...
        a.getClipboardData = function () {
            ...
            if (!m) {
                m = n.createElement('div', {attributes:{id:'cke_hiddenDiv'}, styles:{position:'absolute', visibility:'hidden', overflow:'hidden', width:'1px', height:'1px'}});
                m.setHtml('');
                m.appendTo(o);
            }
    ...
    (function () {
        var l = {modes:{wysiwyg:1, source:1}, canUndo:false, exec:function (n) {
            ...
            if (n.config.fullPage)o = n.getData(); else {
    ...
    (function () {
        var l = 'scaytcheck', m = '', n = function () {
            var r = this, s = function () {
                ...
                var x = new window.scayt(v), y = o.instances[r.name];
                if (y) {
                    x.sLang = y.sLang;
                    x.option(y.option());
                    x.paused = y.paused;
            ...
            if (u)u.addRules({elements:{span:function (v) {
        ...
        j.scayt = {engineLoaded:false, instances:{}, getScayt:function (r) {
            ...
            if (this.engineLoaded === true)return n.apply(r); else if (this.engineLoaded == -1)return a.on('scaytReady', function () {
                n.apply(r);
            });
            a.on('scaytReady', n, r);
            ...
            a._djScaytConfig = {baseUrl:v, addOnLoad:[function () {
                a.fireOnce('scaytReady');
            }], isDebug:false};
            a.document.getHead().append(a.document.createElement('script', {attributes:{type:'text/javascript', src:u}}));
            return null;
        }, parseUrl:function (r) {
            var s;
            if (r.match && (s = r.match(/(.*)[\/\\](.*?\.\w+)$/)))return{path:s[1], file:s[2]}; else return r;
        }};
        var o = j.scayt, p = function (r, s, t, u, v, w, x) {
            r.addCommand(u, v);
            r.addMenuItem(u, {label:t, command:u, group:w, order:x});
        }, q = {preserveState:true, editorFocus:false, exec:function (r) {
            if (o.isScaytReady(r)) {
        ...
        j.add('scayt', {requires:['menubutton'], beforeInit:function (r) {
            ...
            var v = 'scaytButton';
            r.addMenuGroup(v);
            r.addMenuItems({scaytToggle:{label:r.lang.scayt.enable, command:l, group:v}, scaytOptions:{label:r.lang.scayt.options, group:v, onClick:function () {
                m = 'options';
                r.openDialog(l);
            }}, scaytLangs:{label:r.lang.scayt.langs, group:v, onClick:function () {
                m = 'langs';
                r.openDialog(l);
            }}, scaytAbout:{label:r.lang.scayt.about, group:v, onClick:function () {
                m = 'about';
                r.openDialog(l);
            }}});
            r.ui.add('Scayt', 5, {label:r.lang.scayt.title, title:r.lang.scayt.title, className:'cke_button_scayt', onRender:function () {
                u.on('state', function () {
                ...
                return{scaytToggle:2, scaytOptions:x ? 2 : 0, scaytLangs:x ? 2 : 0, scaytAbout:x ? 2 : 0};
            }});
            if (r.contextMenu && r.addMenuItems)r.contextMenu.addListener(function (x) {
                ...
                if (D)r.addMenuItem('scayt_moresuggest', {label:r.lang.scayt.moreSuggestions, group:'scayt_moresuggest', order:10, getItems:function () {
                    return s;
                }});
                var I = {exec:function () {
                    y.ignore(x.$);
    ...
    j.add('sourcearea', {requires:['editingblock'], init:function (l) {
        ...
        l.on('editingBlockReady', function () {
            var n, o;
            l.addMode('source', {load:function (p, q) {
                if (c && b.version < 8)p.setStyle('position', 'relative');
                l.textarea = n = new h('textarea');
                n.setAttributes({dir:'ltr', tabIndex:-1});
                n.addClass('cke_source');
                n.addClass('cke_enable_context_menu');
                var r = {width:b.ie7Compat ? '99%' : '100%', height:'100%', resize:'none', outline:'none', 'text-align':'left'};
                if (c) {
                    if (!b.ie8Compat) {
                        o = function () {
                            n.hide();
    ...
    (function () {
        j.add('stylescombo', {requires:['richcombo', 'styles'], init:function (o) {
            ...
            o.ui.addRichCombo('Styles', {label:q.label, title:q.panelTitle, voiceLabel:q.voiceLabel, className:'cke_styles', multiSelect:true, panel:{css:[a.getUrl(o.skinPath + 'editor.css')].concat(p.contentsCss), voiceLabel:q.panelVoiceLabel}, init:function () {
    ...
    (function () {
        ...
        function p(y, z) {
            ...
            for (B = 0; B < y.length; B++) {
                ...
                if (c)z.rows[B].replaceNode(F); else {
        ...
        j.tabletools = {init:function (y) {
            ...
            y.addCommand('rowDelete', {exec:function (A) {
                var B = A.getSelection();
                s(B);
            }});
            y.addCommand('rowInsertBefore', {exec:function (A) {
                var B = A.getSelection();
                r(B, true);
            }});
            y.addCommand('rowInsertAfter', {exec:function (A) {
                var B = A.getSelection();
                r(B);
            }});
            y.addCommand('columnDelete', {exec:function (A) {
                var B = A.getSelection();
                u(B);
            }});
            y.addCommand('columnInsertBefore', {exec:function (A) {
                var B = A.getSelection();
                t(B, true);
            }});
            y.addCommand('columnInsertAfter', {exec:function (A) {
                var B = A.getSelection();
                t(B);
            }});
            y.addCommand('cellDelete', {exec:function (A) {
                var B = A.getSelection();
                w(B);
            }});
            y.addCommand('cellInsertBefore', {exec:function (A) {
                var B = A.getSelection();
                v(B, true);
            }});
            y.addCommand('cellInsertAfter', {exec:function (A) {
                var B = A.getSelection();
                v(B);
            }});
            if (y.addMenuItems)y.addMenuItems({tablecell:{label:z.cell.menu, group:'tablecell', order:1, getItems:function () {
                var A = n(y.getSelection());
                return{tablecell_insertBefore:2, tablecell_insertAfter:2, tablecell_delete:2, tablecell_properties:A.length > 0 ? 2 : 0};
            }}, tablecell_insertBefore:{label:z.cell.insertBefore, group:'tablecell', command:'cellInsertBefore', order:5}, tablecell_insertAfter:{label:z.cell.insertAfter, group:'tablecell', command:'cellInsertAfter', order:10}, tablecell_delete:{label:z.cell.deleteCell, group:'tablecell', command:'cellDelete', order:15}, tablecell_properties:{label:z.cell.title, group:'tablecellproperties', command:'cellProperties', order:20}, tablerow:{label:z.row.menu, group:'tablerow', order:1, getItems:function () {
                return{tablerow_insertBefore:2, tablerow_insertAfter:2, tablerow_delete:2};
            }}, tablerow_insertBefore:{label:z.row.insertBefore, group:'tablerow', command:'rowInsertBefore', order:5}, tablerow_insertAfter:{label:z.row.insertAfter, group:'tablerow', command:'rowInsertAfter', order:10}, tablerow_delete:{label:z.row.deleteRow, group:'tablerow', command:'rowDelete', order:15}, tablecolumn:{label:z.column.menu, group:'tablecolumn', order:1, getItems:function () {
                return{tablecolumn_insertBefore:2, tablecolumn_insertAfter:2, tablecolumn_delete:2};
            }}, tablecolumn_insertBefore:{label:z.column.insertBefore, group:'tablecolumn', command:'columnInsertBefore', order:5}, tablecolumn_insertAfter:{label:z.column.insertAfter, group:'tablecolumn', command:'columnInsertAfter', order:10}, tablecolumn_delete:{label:z.column.deleteColumn, group:'tablecolumn', command:'columnDelete', order:15}});
            if (y.contextMenu)y.contextMenu.addListener(function (A, B) {
                if (!A)return null;
                while (A) {
                    if (A.getName() in x)return{tablecell:2, tablerow:2, tablecolumn:2};
                    A = A.getParent();
                }
                return null;
            });
            ...
            n.on('themeSpace', function (p) {
                if (p.data.space == n.config.toolbarLocation) {
                    ...
                    for (var v = 0; v < u.length; v++) {
                        var w = u[v];
                        if (!w)continue;
                        var x = 'cke_' + e.getNextNumber(), y = {id:x, items:[]};
                        if (s) {
                            q.push('</div>');
                            s = 0;
                        }
                    ...
                    if (n.config.toolbarCanCollapse) {
                        ...
                        n.addCommand('toolbarCollapse', {exec:function (G) {
    ...
    (function () {
        j.add('undo', {requires:['selection', 'wysiwygarea'], init:function (n) {
            var o = new m(n), p = n.addCommand('undo', {exec:function () {
                if (o.undo()) {
                    n.selectionChange();
                    this.fire('afterUndo');
                }
            }, state:0, canUndo:false}), q = n.addCommand('redo', {exec:function () {
                if (o.redo()) {
                    n.selectionChange();
                    this.fire('afterRedo');
                }
            ...
            n.ui.addButton('Undo', {label:n.lang.undo, command:'undo'});
            n.ui.addButton('Redo', {label:n.lang.redo, command:'redo'});
        ...
        ;
        l.prototype = {equals:function (n, o) {
        ...
        ;
        m.prototype = {type:function (n) {
            var o = n && n.data.getKeystroke(), p = {8:1, 46:1}, q = o in p, r = this.lastKeystroke in p, s = q && o == this.lastKeystroke, t = {37:1, 38:1, 39:1, 40:1}, u = o in t, v = this.lastKeystroke in t, w = !q && !u, x = q && !s, y = !this.typing || w && (r || v);
            if (y || x) {
            ...
            if (n.bookmarks)p.editor.getSelection().selectBookmarks(n.bookmarks); else if (c) {
    ...
    i.undoStackSize = 20;
    (function () {
        var l = {table:1, pre:1}, m = /\s*<(p|div|address|h\d|center)[^>]*>\s*(?:<br[^>]*>|&nbsp;|&#160;)\s*(:?<\/\1>)?\s*$/gi;
        ...
        function q(r) {
            ...
            if (y != 2 && w.collapsed && u.getName() == 'body' && !t.block) {
                ...
                if (I && I.getName && !(I.getName() in l))K = I; else if (J && J.getName && !(J.getName() in l))K = J;
        ...
        ;
        j.add('wysiwygarea', {requires:['editingblock'], init:function (r) {
            ...
            r.on('editingBlockReady', function () {
                var t, u, v, w, x, y, z, A = b.isCustomDomain(), B = function () {
                    ...
                    if (b.gecko) {
                        ...
                        t.setAttributes({role:'region', title:F});
                        v.setAttributes({role:'region', title:' '});
                    } else if (b.webkit) {
                    ...
                    I.on('focus', function () {
                        if (b.gecko) {
                            ...
                            if (!M.nextSibling && 'BR' == M.tagName && M.hasAttribute('_moz_editor_bogus_node')) {
                                ...
                                if (r.config.enterMode == 2)F.createElement('br', {attributes:{_moz_dirty:''}}).replace(O); else O.remove();
                            }
                        }
                ...
                r.addMode('wysiwyg', {load:function (E, F, G) {
                    t = E;
    ...
    (function () {
        ...
        l.prototype = {getNextParagraph:function (n) {
            var O = this;
            var o, p, q, r, s;
            if (!O._.lastNode) {
                p = O.range.clone();
            ...
            while (z) {
                ...
                if (!B) {
                    var D = z.getName();
                    if (z.isBlockBoundary(O.forceBrBreak && {br:1})) {
                        if (D == 'br')B = true; else if (!p && !z.getChildCount() && D != 'hr') {
                            o = z;
                            q = z.equals(v);
                            break;
                        }
                ...
                if (p && !A)while (!z.getNext() && !q) {
                    var E = z.getParent();
                    if (E.isBlockBoundary(O.forceBrBreak && {br:1})) {
                        A = true;
                        q = q || E.equals(v);
                        break;
                    }
            ...
            if (!o) {
                ...
                var I = G.blockLimit, J = {div:1, th:1, td:1};
                o = G.block;
                if (!o && !O.enforceRealBlocks && J[I.getName()] && p.checkStartOfBlock() && p.checkEndOfBlock())o = I; else if (!o || O.enforceRealBlocks && o.getName() == 'li') {
    ...
    (function () {
        ...
        k.floatPanel = e.createClass({$:function (o, p, q, r) {
            ...
            v.setStyles({top:B + 'px', left:'-3000px', visibility:'hidden', opacity:'0', display:''});
            if (!this._.blurSet) {
            ...
            e.setTimeout(function () {
                ...
                v.setStyles({left:A + 'px', visibility:'', opacity:'1'});
                if (u.autoSize) {
                    function D() {
    ...
    e.extend(a.editor.prototype, {addMenuGroup:function (l, m) {
    ...
    (function () {
        a.menu = e.createClass({$:function (m, n) {
            ...
            if (!s) {
                s = this._.panel = new k.floatPanel(this.editor, a.document.getBody(), {css:[a.getUrl(r.skinPath + 'editor.css')], level:this._.level - 1, className:r.skinClass + ' cke_contextmenu'}, this._.level);
    ...
    (function () {
        ...
        var r = {img:1, hr:1, li:1, table:1, tr:1, td:1, embed:1, object:1, ol:1, ul:1, a:1, input:1, form:1, select:1, textarea:1, button:1, fieldset:1, th:1, thead:1, tfoot:1};
            ...
            var s = function (t, u) {
                ...
                for (var y = 0; y < w.length; y++) {
                    ...
                    if (z.nodeType == 1) {
                        ...
                        if (A > 0)break; else if (A === 0)return{container:v, offset:y};
                        x = null;
                    }
                }
                if (!x) {
                ...
                if (B === 0)return{container:v, offset:y}; else return{container:w[y], offset:-B};
            };
            return function () {
                var E = this;
                var t = E._.cache;
    ...
    a.editor.prototype.createFakeElement = function (l, m, n, o) {
        var p = this.lang.fakeobjects, q = {'class':m, src:a.getUrl('images/spacer.gif'), _cke_realelement:encodeURIComponent(l.getOuterHtml()), alt:p[n] || p.unknown};
    ...
    a.editor.prototype.createFakeParserElement = function (l, m, n, o) {
        ...
        l.writeHtml(p);
        var q = p.getHtml(), r = this.lang.fakeobjects, s = {'class':m, src:a.getUrl('images/spacer.gif'), _cke_realelement:encodeURIComponent(q), alt:r[n] || r.unknown};
    ...
    k.richCombo = e.createClass({$:function (l) {
        ...
        }, this), p = {id:n, combo:this, focus:function () {
    ...
    a.htmlWriter = e.createClass({base:a.htmlParser.basicWriter, $:function () {
        ...
        n._.rules = {};
        var l = f;
        for (var m in e.extend({}, l.$block, l.$listItem, l.$tableContent))n.setRules(m, {indent:true, breakBeforeOpen:true, breakAfterOpen:true, breakBeforeClose:!l[m]['#'], breakAfterClose:true});
    ...
    (function () {
        ...
        function m() {
            ...
            for (var O = N - 1; O > N - M; O--)if (l.call(P, P._.tabIdList[O % M]))return P._.tabIdList[O % M];
            return null;
        }
        ...
        a.dialog = function (L, M) {
            ...
            N = e.clone(N);
            N = new u(this, N);
            this.definition = N = a.fire('dialogDefinition', {name:M, definition:N}, L).definition;
            var O = a.document, P = L.theme.buildDialog(L);
            this._ = {editor:L, element:P.element, name:M, contentSize:{width:0, height:0}, size:{width:0, height:0}, updateSize:false, contents:{}, buttons:{}, accessKeyMap:{}, tabs:{}, tabIdList:[], currentTabId:null, currentTabIndex:null, pageCount:0, lastTab:null, tabBarMode:false, focusList:[], currentFocusIndex:0, hasFocus:false};
            this.parts = P.parts;
            ...
            var X = [], Y = a.dialog._.uiElementBuilders.hbox.build(this, {type:'hbox', className:'cke_dialog_footer_buttons', widths:[], children:N.buttons}, X).getChild();
        ...
        function p(L, M, N) {
            ...
            M.on('keydown', function (O) {
                if (O.data.getKeystroke() in {32:1, 13:1})this.fire('click');
            });
            M.on('focus', function () {
                this.fire('mouseover');
            });
        ...
        a.dialog.prototype = {resize:(function () {
            return function (L, M) {
                ...
                a.dialog.fire('resize', {dialog:N, skin:N._.editor.skinName, width:L, height:M}, N._.editor);
                N._.contentSize = {width:L, height:M};
                N._.updateSize = true;
            };
        })(), getSize:function () {
            var N = this;
            if (!N._.updateSize)return N._.size;
            var L = N._.element.getFirst(), M = N._.size = {width:L.$.offsetWidth || 0, height:L.$.offsetHeight || 0};
            ...
            return function (M, N) {
                ...
                Q._.position = {x:M, y:N};
                if (!L) {
                    var P = a.document.getWindow().getScrollPosition();
                    M += P.x;
                    N += P.y;
                }
                O.setStyles({left:(M > 0 ? M : 0) + ('px'), top:(N > 0 ? N : 0) + ('px')});
            };
            ...
            if (a.dialog._.currentTop === null) {
                ...
                for (var O in {keyup:1, keydown:1, keypress:1})a.document.on(O, K);
            } else {
            ...
            if (!this._.parentDialog) {
                ...
                for (var N in {keyup:1, keydown:1, keypress:1})a.document.removeListener(N, K);
                var O = this._.editor;
                O.focus();
            ...
            var V = this;
            var M = [], N = L.label ? ' title="' + e.htmlEncode(L.label) + '"' : '', O = L.elements, P = a.dialog._.uiElementBuilders.vbox.build(V, {type:'vbox', className:'cke_dialog_page_contents', children:L.elements, expand:!!L.expand, padding:L.padding, style:L.style || 'width: 100%; height: 100%;'}, M), Q = h.createFromHtml(M.join('')), R = h.createFromHtml(['<a class="cke_dialog_tab"', V._.pageCount > 0 ? ' cke_last' : 'cke_first', N, !!L.hidden ? ' style="display:none"' : '', ' id="', L.id + '_', e.getNextNumber(), '" href="javascript:void(0)"', ' hidefocus="true">', L.label, '</a>'].join(''));
        ...
        e.extend(a.dialog, {add:function (L, M) {
            ...
            var L = function (M, N) {
                N = N || {};
                return e.extend({id:'ok', type:'button', label:M.lang.common.ok, 'class':'cke_dialog_ui_button_ok', onClick:function (O) {
                    var P = O.data.dialog;
                    if (P.fire('ok', {hide:true}).hide !== false)P.hide();
                }}, N, true);
            };
            L.type = 'button';
            ...
            var L = function (M, N) {
                N = N || {};
                return e.extend({id:'cancel', type:'button', label:M.lang.common.cancel, 'class':'cke_dialog_ui_button_cancel', onClick:function (O) {
                    var P = O.data.dialog;
                    if (P.fire('cancel', {hide:true}).hide !== false)P.hide();
                }}, N, true);
            };
            L.type = 'button';
            L.override = function (M) {
        ...
        var q = {resizable:0, minWidth:600, minHeight:400, buttons:[a.dialog.okButton, a.dialog.cancelButton]}, r = function (L, M, N) {
        ...
        u.prototype = {getContents:function (L) {
        ...
        function w(L) {
            ...
            function S(U) {
                ...
                N.x += Z;
                N.y += aa;
                if (N.x + R[3] < Q)ab = -R[3]; else if (N.x - R[1] > W.width - V.width - Q)ab = W.width - V.width + R[1]; else ab = N.x;
                if (N.y + R[0] < Q)ac = -R[0]; else if (N.y - R[2] > W.height - V.height - Q)ac = W.height - V.height + R[2]; else ac = N.y;
                L.move(ab, ac);
            ...
            L.parts.title.on('mousedown', function (U) {
                L._.updateSize = true;
                M = {x:U.data.$.screenX, y:U.data.$.screenY};
        ...
        function x(L) {
            ...
            function Z(ac) {
                ...
                W = L.getPosition();
                e.extend(W, {x2:W.x + ae.width, y2:W.y + ae.height});
                V = {x:ac.data.$.screenX, y:ac.data.$.screenY};
                a.document.on('mousemove', aa, L, {part:ad});
                a.document.on('mouseup', ab, L, {part:ad});
                if (b.ie6Compat) {
                    var af = z.getChild(0).getFrameDocument();
                    af.on('mousemove', aa, L, {part:ad});
                    af.on('mouseup', ab, L, {part:ad});
                }
            ...
            function aa(ac) {
                ...
                V = {x:ad, y:ae};
                var aj, ak, al, am;
                if (W.x + Q[3] < X)aj = -Q[3]; else if (ai.search('l') != -1 && W.x2 - W.x < N + X)aj = W.x2 - N; else aj = W.x;
                if (W.y + Q[0] < X)ak = -Q[0]; else if (ai.search('t') != -1 && W.y2 - W.y < O + X)ak = W.y2 - O; else ak = W.y;
                if (W.x2 - Q[1] > ah.width - X)al = ah.width + Q[1]; else if (ai.search('r') != -1 && W.x2 - W.x < N + X)al = W.x + N; else al = W.x2;
                if (W.y2 - Q[2] > ah.height - X)am = ah.height + Q[2]; else if (ai.search('b') != -1 && W.y2 - W.y < O + X)am = W.y + O; else am = W.y2;
                L.move(aj, ak);
        ...
        var y, z, A = function (L) {
            ...
            var P = z, Q = function () {
                ...
                P.setStyles({width:U.width + 'px', height:U.height + 'px'});
            }, R = function () {
                var U = M.getScrollPosition(), V = a.dialog._.currentTop;
                P.setStyles({left:U.x + 'px', top:U.y + 'px'});
                do {
                    var W = V.getPosition();
                    V.move(W.x, W.y);
            ...
            var Q = C[N] || (C[N] = []);
            Q.push({uiElement:L, dialog:M, key:N, keyup:P || L.accessKeyUp, keydown:O || L.accessKeyDown});
        }, G = function (L) {
            for (var M in C) {
                var N = C[M];
                for (var O = N.length - 1; O >= 0; O--)if (N[O].dialog == L || N[O].uiElement == L)N.splice(O, 1);
                if (N.length === 0)delete C[M];
            }
        }, H = function (L, M) {
            if (L._.accessKeyMap[M])L.selectPage(L._.accessKeyMap[M]);
        }, I = function (L, M) {
        }, J = {27:1, 13:1}, K = function (L) {
            if (L.data.getKeystroke() in J)L.data.stopPropagation();
        };
        (function () {
            k.dialog = {uiElement:function (L, M, N, O, P, Q, R) {
                ...
                for (Z = 0; Z < ab.length; Z++)if (ab[Z])aa[ab[Z]] = 1;
                var ac = [];
                ...
                for (Z = ad.length - 1; Z >= 0; Z--)if (ad[Z] === '')ad.splice(Z, 1);
                ...
                k.dialog.uiElement.call(this, L, P || {type:'hbox'}, O, 'table', T, P && P.align && {align:P.align} || null, V);
                ...
                var Q = this._.children = M, R = P && P.width || null, S = P && P.heights || null, T = function () {
                    ...
                    for (var V = 0; V < N.length; V++) {
                        ...
                        if (S)W.push('height:' + e.cssLength(S[V])); else if (P && P.expand)W.push('height:' + Math.floor(100 / N.length) + '%');
                ...
                k.dialog.uiElement.call(this, L, P || {type:'vbox'}, O, 'div', null, null, T);
            }};
        })();
        k.dialog.uiElement.prototype = {getElement:function () {
            ...
            return this;
        }, eventProcessors:{onLoad:function (L, M) {
            L.on('load', M, this);
        }, onShow:function (L, M) {
            L.on('show', M, this);
        }, onHide:function (L, M) {
        ...
        k.dialog.hbox.prototype = e.extend(new k.dialog.uiElement(), {getChild:function (L) {
            var M = this;
        ...
        a.dialogCommand.prototype = {exec:function (L) {
        ...
        (function () {
            ...
            a.dialog.validate = {functions:function () {
                return function () {
                    ...
                    for (S = 0; S < arguments.length; S++)if (typeof arguments[S] == 'function')R.push(arguments[S]); else break;
                    ...
                    for (S = 0; S < R.length; S++)if (Q == 2)T = T && R[S](O); else T = T || R[S](O);
                    if (!T) {
        ...
        a.skins.add = (function () {
            var L = a.skins.add;
            return function (M, N) {
                o[M] = {margins:N.margins};
                return L.apply(this, arguments);
            };
        })();
    })();
    e.extend(a.editor.prototype, {openDialog:function (l) {
    ...
    k.panel.block = e.createClass({$:function (l) {
        var m = this;
        m.element = l.append(l.getDocument().createElement('div', {attributes:{'class':'cke_panel_block'}, styles:{display:'none'}}));
        m.keys = {};
        m._.focusIndex = -1;
    ...
    (function () {
        var l = function (s) {
            ...
            e.extend.apply(e, t);
            return v._;
        }, m = {build:function (s, t, u) {
            return new k.dialog.textInput(s, t, u);
        }}, n = {build:function (s, t, u) {
        ...
        }}, p = e.extend({}, k.dialog.uiElement.prototype.eventProcessors, {onChange:function (s, t) {
        ...
        e.extend(k.dialog, {labeledElement:function (s, t, u, v) {
            if (arguments.length < 4)return;
            var w = l.call(this, t);
            w.labelId = e.getNextNumber() + '_label';
            var x = this._.children = [], y = function () {
                var z = [];
                if (t.labelLayout != 'horizontal')z.push('<div class="cke_dialog_ui_labeled_label" id="', w.labelId, '" >', t.label, '</div>', '<div class="cke_dialog_ui_labeled_content">', v(s, t), '</div>'); else {
                    var A = {type:'hbox', widths:t.widths, padding:0, children:[
                        {type:'html', html:'<span class="cke_dialog_ui_labeled_label" id="' + w.labelId + '">' + e.htmlEncode(t.label) + '</span>'},
                        {type:'html', html:'<span class="cke_dialog_ui_labeled_content">' + v(s, t) + '</span>'}
                    ]};
            ...
            if (arguments.length < 3)return;
            l.call(this, t);
            var v = this._.inputId = e.getNextNumber() + '_textInput', w = {'class':'cke_dialog_ui_input_' + t.type, id:v, type:'text'}, x;
            ...
            if (arguments.length < 3)return;
            var v = l.call(this, t, {'default':!!t['default']});
            if (t.validate)this.validate = t.validate;
            var w = function () {
                var x = e.extend({}, t, {id:t.id ? t.id + '_checkbox' : e.getNextNumber() + '_checkbox'}, true), y = [], z = {'class':'cke_dialog_ui_checkbox_input', type:'checkbox'};
                r(x);
            ...
            var v = [], w = this, x = function () {
                var y = [], z = [], A = {'class':'cke_dialog_ui_radio_item'}, B = t.id ? t.id + '_radio' : e.getNextNumber() + '_radio';
                for (var C = 0; C < t.items.length; C++) {
                    var D = t.items[C], E = D[2] !== undefined ? D[2] : D[0], F = D[1] !== undefined ? D[1] : D[0], G = e.extend({}, t, {id:e.getNextNumber() + '_radio_input', title:null, type:null}, true), H = e.extend({}, G, {id:null, title:E}, true), I = {type:'radio', 'class':'cke_dialog_ui_radio_input', name:B, value:F}, J = [];
                    if (w._['default'] == F)I.checked = 'checked';
                    r(G);
                    r(H);
                    v.push(new k.dialog.uiElement(s, G, J, 'input', null, I));
                    J.push(' ');
                    new k.dialog.uiElement(s, H, J, 'label', null, {'for':I.id}, D[0]);
                    y.push(J.join(''));
                }
            ...
            l.call(this, t, {disabled:t.disabled || false});
            a.event.implementOn(this);
            var v = this;
            s.on('load', function (x) {
                ...
                (function () {
                    y.on('click', function (z) {
                        v.fire('click', {dialog:v.getDialog()});
                        z.data.preventDefault();
                    });
                })();
                y.unselectable();
            ...
            var w = e.extend({}, t);
            delete w.style;
            k.dialog.uiElement.call(this, s, w, u, 'a', null, {style:t.style, href:'javascript:void(0)', title:t.label, hidefocus:'true', 'class':t['class']}, '<span class="cke_dialog_ui_button">' + e.htmlEncode(t.label) + '</span>');
        }, select:function (s, t, u) {
            if (arguments.length < 3)return;
            var v = l.call(this, t);
            if (t.validate)this.validate = t.validate;
            var w = function () {
                var x = e.extend({}, t, {id:t.id ? t.id + '_select' : e.getNextNumber() + '_select'}, true), y = [], z = [], A = {'class':'cke_dialog_ui_input_select'};
        ...
        k.dialog.labeledElement.prototype = e.extend(new k.dialog.uiElement(), {setLabel:function (s) {
        ...
        }, eventProcessors:p}, true);
        k.dialog.button.prototype = e.extend(new k.dialog.uiElement(), {click:function () {
            var s = this;
            if (!s._.disabled)return s.fire('click', {dialog:s._.dialog});
            s.getElement().$.blur();
            return false;
        }, enable:function () {
        ...
        }, eventProcessors:e.extend({}, k.dialog.uiElement.prototype.eventProcessors, {onClick:function (s, t) {
            this.on('click', t);
        ...
        k.dialog.radio.prototype = e.extend(new k.dialog.uiElement(), {setValue:function (s) {
                ...
                s.on('load', function () {
                    ...
                    for (var w = 0; w < u.length; w++) {
                        ...
                        x.on('propertychange', function (y) {
                            y = y.data.$;
                            if (y.propertyName == 'checked' && this.$.checked)v.fire('change', {value:this.getAttribute('value')});
                        });
                    }
                }, this);
                this.on('change', t);
        ...
        k.dialog.file.prototype = e.extend(new k.dialog.labeledElement(), o, {getInputElement:function () {
            ...
            return '';
        }, eventProcessors:p, keyboardFocusable:true}, true);
    ...
    a.skins.add('kama', (function () {
        ...
        return{preload:l, editor:{css:['editor.css']}, dialog:{css:['dialog.css']}, templates:{css:['templates.css']}, margins:[0, 0, 0, 0], init:function (m) {
            ...
            ;
            var t = /\$color/g;
            e.extend(m, {uiColor:null, getUiColor:function () {
                return this.uiColor;
    ...
    if (a.dialog)a.dialog.on('resize', function (l) {
        ...
        q.setStyles(c || b.gecko && b.version < 10900 ? {width:n + 'px', height:o + 'px'} : {'min-width':n + 'px', 'min-height':o + 'px'});
        if (!c)return;
        setTimeout(function () {
    ...
    a.themes.add('default', (function () {
        return{build:function (l, m) {
            var n = l.name, o = l.element, p = l.elementMode;
            if (!o || p == 0)return;
            if (p == 1)o.hide();
            var q = l.fire('themeSpace', {space:'top', html:''}).html, r = l.fire('themeSpace', {space:'contents', html:''}).html, s = l.fireOnce('themeSpace', {space:'bottom', html:''}).html, t = r && l.config.height, u = l.config.tabIndex || l.element.getAttribute('tabindex') || 0;
            if (!r)t = 'auto'; else if (!isNaN(t))t += 'px';
            ...
            return{element:n, parts:{dialog:n.getChild(0), title:o.getChild(0), close:o.getChild(1), tabs:o.getChild(2), contents:o.getChild(3), footer:o.getChild(4)}};
        }, destroy:function (l) {

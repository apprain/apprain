...
class Development_View_Bootstrap_Definition_Helpers_Data extends appRain_Base_Objects {
	...
	public function getMenu(){
		...
		$default_content =  
			'<nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark" aria-label="Thirteenth navbar example">
